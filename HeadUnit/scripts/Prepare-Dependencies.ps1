...
& (Join-Path $vcpkgRoot 'vcpkg.exe') install boost-asio:x64-windows boost-endian:x64-windows protobuf:x64-windows openssl:x64-windows 'ffmpeg[core,avcodec,avformat,swresample,swscale]:x64-windows' --recurse --disable-metrics
